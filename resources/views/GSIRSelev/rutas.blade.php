...
<x-app-layout>
  ...
  <div style="display: flex; justify-content: center;">
    <a href="/ruta/{{ urlencode($ruta->{'No_ ruta diaria'}) }}" class="btn mt-1 mb-1" style="background-color: #79B329; width: 350px; height: 60px; color: white; display: flex; align-items: center; justify-content: space-between; border-radius: 10px; margin: 0; padding-left: 10px; padding-right: 0; overflow: hidden;">
      <div style="flex-shrink: 0;">
        <i class="fa-solid fa-route fa-xl"></i>
      </div>
      <div style="flex-grow: 1; text-align: center;">
        <b>{{ $ruta->{'No_ ruta diaria'} }}:</b><span class="ml-2" style="color: #efefef;">{{$ruta->{'Descripcion'} }}</span>
      </div>
