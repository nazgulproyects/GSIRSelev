<x-app-layout>
    @section('rutas')
    <x-nav-link href="#" active>Planificación rutas</x-nav-link>
    @endsection
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="row d-flex mb-2">
                <div class="col-6 d-flex justify-content-start">
                    <x-main_title title="PLANIFICACIÓN RUTAS" imagen="{{ asset('images/rutas.png') }}" />
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <x-button type="button" onclick="$('#modalNuevaPlanificacionRuta').modal('show');">Nueva Planificación</x-button>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
