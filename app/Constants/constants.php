...
// CONEXIONES
define('SELEV_BC', 'selev_bc');


define('SELEV', 'dbo.SEBOS LEVANTINOS, S_L_');

//define('REMITTEL', 'dbo.REMITTEL 2017, S_L_');
define('REMITTEL', 'dbo.TEST_REMITTEL 2017, S_L_');


// Tablas para consutas SQL directas
define('SELEV_SQL', 'SEBOS LEVANTINOS, S_L_');
//define('REMITTEL_SQL', 'REMITTEL 2017, S_L_');
define('REMITTEL_SQL', 'TEST_REMITTEL 2017, S_L_');

// TABLAS
define('SELEV_Ruta_diaria', SELEV . '$Ruta diaria$f4e2b823-5811-49c6-a41c-7c9707074208');
